    ...
    private function seedMenus(): array
    {
        ...
        $submenus = [
            ...
            'ACCOUNTING' => [
                ...
                ['code' => 'ACCOUNTING_ACCOUNTS', 'caption' => 'Chart of Accounts', 'link' => '/accounting/accounts', 'icon' => 'BookOpen', 'seq' => 127],
                ['code' => 'ACCOUNTING_JOURNALS', 'caption' => 'Journal Entries', 'link' => '/accounting/journals', 'icon' => 'BookMarked', 'seq' => 128],
                ['code' => 'ACCOUNTING_GL', 'caption' => 'General Ledger', 'link' => '/accounting/general-ledger', 'icon' => 'FileSpreadsheet', 'seq' => 129],
                ['code' => 'ACCOUNTING_REPORTS', 'caption' => 'Financial Reports', 'link' => '/accounting/reports', 'icon' => 'LineChart', 'seq' => 130],
                ['code' => 'ACCOUNTING_TAX_PERIODS', 'caption' => 'Tax Periods', 'link' => '/accounting/tax-periods', 'icon' => 'CalendarCheck', 'seq' => 131],
            ],
            'WNE' => [
