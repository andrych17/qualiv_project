...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('INVENTORY.transfers')) {
        ...
        if (! Schema::hasTable('INVENTORY.transfer_lines')) {
        ...
        if (! Schema::hasTable('INVENTORY.adjustment_reasons')) {
        ...
        if (! Schema::hasTable('INVENTORY.adjustments')) {
        ...
        if (! Schema::hasTable('INVENTORY.adjustment_lines')) {
