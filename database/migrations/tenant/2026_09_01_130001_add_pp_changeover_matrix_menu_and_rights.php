...
/**
 * PP_SPECS.md §3J — the PP_CHANGEOVER_MATRIX menu entry, for tenants already provisioned before
 * this section shipped. Same pattern as 2026_09_01_110001_add_pp_schedule_ops_menu_and_rights.php;
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $menu = ConfigMenu::query()->updateOrCreate(
            ['app_code' => self::APP, 'code' => 'PP_CHANGEOVER_MATRIX'],
            [
                'parent_id' => $parent->id,
                'menu_header' => $parent->menu_header,
                'menu_caption' => 'Changeover Matrix',
                'menu_link' => '/pp/changeover-matrix',
                'icon' => 'Shuffle',
                'seq' => 173,
                'status_code' => 'A',
