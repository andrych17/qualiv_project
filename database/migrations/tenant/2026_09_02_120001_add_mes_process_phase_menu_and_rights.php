...
/**
 * MES module — Process Phases & Parameters menu entry (MES_SPECS.md §3F), added under the
 * existing MES parent menu. Same pattern as MES_ROUTINGS's own menu migration.
 */
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $menu = ConfigMenu::query()->updateOrCreate(
            ['app_code' => self::APP, 'code' => 'MES_PROCESS_PHASES'],
            [
                'parent_id' => $parent->id,
                'menu_header' => $parent->menu_header,
                'menu_caption' => 'Process Phases',
                'menu_link' => '/mes/process-phases',
                'icon' => 'Thermometer',
                'seq' => 235,
                'status_code' => 'A',
