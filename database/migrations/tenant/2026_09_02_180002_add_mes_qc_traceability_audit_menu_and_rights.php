...
/**
 * MES module — QC Inspection Plans (§3L), Traceability (§3K), and Audit Trail (§3U) menu
 * entries, added under the existing MES parent menu. Same pattern as MES_ROUTINGS's own menu
 * migration.
 */
