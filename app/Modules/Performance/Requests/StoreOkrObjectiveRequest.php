...
/** Structure/existence checks only — the parent-cycle guard is a business rule enforced in OkrObjectiveService::assertNoCycle(). */
class StoreOkrObjectiveRequest extends FormRequest
{
