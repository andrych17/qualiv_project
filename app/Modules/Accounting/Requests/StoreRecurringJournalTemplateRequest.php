...
/** §3P — recurring journal template header + N lines. Balance is checked in RecurringJournalTemplateService::replaceLines(), not here (unlike a one-off journal, an unbalanced template would draft an unbalanced journal every occurrence). */
class StoreRecurringJournalTemplateRequest extends FormRequest
{
