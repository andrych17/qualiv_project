...
/** §3I — percentage validation (targets sum to 100, source not among targets) happens in AllocationRuleService, not here — it needs the source_cost_center_id/targets pairing as a unit, same as JournalService's balance check living in the service, not the request. */
