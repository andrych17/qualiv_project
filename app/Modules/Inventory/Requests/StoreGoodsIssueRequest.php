...
/**
 * Draft issues are freely editable (§3E) — this only checks structure and that referenced
 * rows exist. Over-issue and location/warehouse matching are post-time-only rules
 * (GoodsIssueService::post()), not enforced here.
 */
