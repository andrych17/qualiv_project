...
|---|---|---|
| `simon@nusaevo.com` (or `CENTRAL_ADMIN_EMAIL` env) | `password` (or `CENTRAL_ADMIN_PASSWORD` env) | Seeded by `CentralSeeder`. Separate `central_admin` guard — not a tenant user. |
