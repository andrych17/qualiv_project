<!-- ponytail: Add Machine (MES_SPECS.md §3D) -->
...
const submit = () => form.post(route('mes.machines.store'))
</script>

<template>
  <AppLayout>
    <PageHeader title="Add Machine" description="A machine within a work center." />
