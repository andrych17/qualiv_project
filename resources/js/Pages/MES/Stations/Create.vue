<!-- ponytail: Add Station (MES_SPECS.md §3D) -->
...
const submit = () => form.post(route('mes.stations.store'))
</script>

<template>
  <AppLayout>
    <PageHeader title="Add Station" description="Must belong to a work center or a machine (or both)." />
