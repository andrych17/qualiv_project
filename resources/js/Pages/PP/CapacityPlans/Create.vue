<!-- ponytail: Add Capacity Plan (PP_SPECS.md §3F) -->
...
const submit = () => form.post(route('pp.capacityPlans.store'))
</script>

<template>
  <AppLayout>
    <PageHeader title="Add Capacity Plan" description="Rough-cut required vs. available hours for a work center, machine, or resource group over a period." />
