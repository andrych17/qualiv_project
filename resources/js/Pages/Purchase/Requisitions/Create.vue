<!-- Purchase Requisition Create (§3B) -->
...
<template>
  <AppLayout>
    <PageHeader title="New Purchase Requisition" description="Draft a new procurement requisition (§3B).">
      <template #actions>
        <SecondaryButton :href="route('purchase.requisitions.index')">Cancel</SecondaryButton>
      </template>
    </PageHeader>
    ...
    <form class="mt-6 space-y-6" @submit.prevent="submit">
      <Panel title="Requisition Details">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <FormSelect
            ...
            name="requester_id"
            label="Requester"
            placeholder="Select requester (defaults to you)"
      ...
      <div class="flex justify-end gap-3">
        <SecondaryButton :href="route('purchase.requisitions.index')">Cancel</SecondaryButton>
        <PrimaryButton type="submit" :disabled="form.processing">Save Requisition</PrimaryButton>
      </div>
    </form>
  </AppLayout>
</template>
