...
const blankLine = () => ({ description: '', qty: '1', unit_price: '', discount_amount: '0', tax_code_id: null as number | null, expense_account_id: (props.expenseAccounts[0]?.value ?? null) as number | null })
const toFormLine = (l: LineRow) => ({ description: l.description, qty: String(l.qty), unit_price: String(l.unit_price), discount_amount: String(l.discount_amount), tax_code_id: l.tax_code_id, expense_account_id: l.expense_account_id as number | null })
