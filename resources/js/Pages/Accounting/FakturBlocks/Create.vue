...
<template>
  <AppLayout>
    <PageHeader title="New Faktur Pajak number block" description="Enter the range exactly as allocated by DJP — numbers are drawn sequentially and never reused." />
    ...
    <Panel class="mt-6 max-w-xl">
      <form class="space-y-4" @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          <Link
            :href="route('accounting.faktur-blocks.index', { company_id: form.company_id })"
