...
<template>
  <AppLayout>
    <PageHeader title="New inventory GL mapping" description="Set either an item or a category, not both — an item-level mapping overrides its category's mapping when both exist." />
    ...
    <Panel class="mt-6 max-w-2xl">
      <form class="space-y-4" @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          <Link
            :href="route('accounting.inventory-gl-mappings.index', { company_id: form.company_id })"
