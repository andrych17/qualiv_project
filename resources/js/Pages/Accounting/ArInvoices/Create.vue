...
<template>
  <AppLayout>
    <PageHeader title="New Customer Invoice" description="Saved as draft — posting creates the AR journal and Faktur Pajak." />
    ...
    <Panel class="mt-6">
      <form class="space-y-6" @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          <SecondaryButton :href="route('accounting.ar-invoices.index', { company_id: form.company_id })">
            Cancel
          </SecondaryButton>
