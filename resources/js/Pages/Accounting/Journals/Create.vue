...
<template>
  <AppLayout>
    <PageHeader title="New journal" description="Saved as a draft — balance and control-account rules are enforced when you post it." />
    ...
    <Panel class="mt-6">
      <form class="space-y-6" @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          <Link
            :href="route('accounting.journals.index', { company_id: form.company_id })"
