...
<template>
  <AppLayout>
    <PageHeader title="New Bank Account" description="Register a bank or cash account mapped to its underlying GL account." />
    ...
    <Panel class="mt-6 max-w-xl">
      <form class="space-y-4" @submit.prevent="submit">
        ...
        <FormInput v-model="form.bank_name" name="bank_name" label="Bank Name" placeholder="e.g. Bank Central Asia" :error="form.errors.bank_name" />
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          <SecondaryButton :href="route('accounting.bank-accounts.index', { company_id: form.company_id })">
            Cancel
          </SecondaryButton>
