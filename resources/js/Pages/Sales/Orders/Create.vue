...
<template>
  <AppLayout>
    <PageHeader
      ...
      description="Direct order entry for services or products (§3F)."
    />
    ...
    <div class="mt-6">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3">
          <SecondaryButton :href="route('sales.orders.index')">Cancel</SecondaryButton>
          <PrimaryButton type="submit" :disabled="form.processing">Save Sales Order</PrimaryButton>
        </div>
      </form>
    </div>
  </AppLayout>
