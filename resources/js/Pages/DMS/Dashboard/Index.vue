<!-- ponytail: DMS §3A Main Dashboard (Document Library) — folder tree + filterable document
     table, and a row-click drawer (metadata/versions/audit/relations tabs) fetched the same
     way CRM's own dashboard drawer works (resources/js/Pages/CRM/Dashboard/Index.vue).
     "Upload" now links to the §3B dedicated entry form (DMS/Documents/Create.vue), same
