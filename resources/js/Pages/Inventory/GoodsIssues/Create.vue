<!-- ponytail: New Goods Issue (§3E) — always starts as a draft; posting is a separate step. -->
...
const form = useForm({
  ...
  reason: '' as string,
  lines: [] as IssueLineRow[],
})

const submit = () => form.post(route('inventory.goodsIssues.store'))
</script>

<template>
  <AppLayout>
    <PageHeader title="New Goods Issue" description="Saved as a draft — post it once the lines are correct." />
