...
const submit = () => form.post(route('inventory.categories.store'))
</script>
    ...
    <Panel class="mt-6 max-w-xl">
      <form class="space-y-4" @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-border pt-4">
          ...
          <PrimaryButton type="submit" :disabled="form.processing">Save category</PrimaryButton>
        </div>
      </form>
    </Panel>
  </AppLayout>
